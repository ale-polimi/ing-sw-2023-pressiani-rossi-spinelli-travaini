...
public class NetworkView implements View {
   ...
   public void sendMessageTo(Message message) {
    ...
    @Override
    public void showGenericError(String payload) {
       try{server.sendMessage(new GenericErrorMessage("Controller", payload));}
       catch(RemoteException e){System.err.println("Cannot send the generic error to the view");}
    }
